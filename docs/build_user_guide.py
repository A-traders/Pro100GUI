...
def build_story():
    ...
    s.append(tip(
        "После успешного завершения прогона эта папка <b>открывается "
        "автоматически</b> в Проводнике -- сразу видите свежий "
        "<i>Pro100_*.pdf</i>. При неудачном завершении папка не открывается, "
        "ее можно открыть кнопкой <b>Open results folder</b> на вкладке "
        "Результаты."
    ))
